...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # Function: epsilon = a^t, 0 < a < 1
            # a = 0.7
            # self.epsilon = 0.8**self.number_of_trials

            # Function: 1/t^2
            # self.epsilon = 1.0/(self.number_of_trials**2)

            # Function: e^(-a*t), 0 < a < 1
            a = 0.03
            self.epsilon = math.exp( -a * self.number_of_trials )

            # Function: cos(a*t), 0 < a < 1
            # a = 0.03
            # self.epsilon = math.cos( a * self.number_of_trials )
    ...
    def choose_action(self, state):
        ...
        # Be sure that when choosing an action with highest Q-value that you randomly select between actions that "tie".
            ...
            argmax_actions =  [k for k,v in self.Q[state].items() if v == maxQ] #get all keys with the highest value
